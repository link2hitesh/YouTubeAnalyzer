...
public class ChannelServiceImpl implements YoutubeServiceApi {
    ...
    public CompletionStage<List<String>> search(String word){
        ...
        return CompletableFuture.supplyAsync(()->Search(word));
      //  return null;
    }
    /**
     * @param channelId
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore) throws IOException {
        ...
        Reader clientSecretReader = new InputStreamReader(ChannelServiceImpl.class.getResourceAsStream("/client_secrets.json"));
