...
/**
 * this is the modfied youtube api that return channel content
 * @author Adeyinka
 *
 */
public class OwnerPageApi{
    ...
    public static Credential authorize(List<String> scopes, String credentialDatastore) throws IOException {
        ...
        Reader clientSecretReader = new InputStreamReader(OwnerPageApi.class.getResourceAsStream("/client_secrets.json"));
